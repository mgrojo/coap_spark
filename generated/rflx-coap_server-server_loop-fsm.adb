...
with RFLX.CoAP_Server.Contains;
with RFLX.RFLX_Types.Operators;

package body RFLX.CoAP_Server.Server_Loop.FSM with
  SPARK_Mode
is
   ...
   use type RFLX.CoAP.Token_Length;
   ...
   begin
      ...
      -- specs/coap_server.rflx:47:10
      declare
         Definite_Response : CoAP_Server.Definite_Message.Structure;
      ...
      begin
         ...
         if not CoAP_Server.Definite_Message.Valid_Structure (Definite_Response) then
            Ctx.P.Next_State := S_Failure;
            pragma Assert (Treat_Request_Invariant);
            goto Finalize_Treat_Request;
         end if;
         if not CoAP_Server.Definite_Message.Sufficient_Buffer_Length (Ctx.P.Definite_Response_Ctx, Definite_Response) then
            Ctx.P.Next_State := S_Failure;
            pragma Assert (Treat_Request_Invariant);
            goto Finalize_Treat_Request;
         end if;
         CoAP_Server.Definite_Message.To_Context (Definite_Response, Ctx.P.Definite_Response_Ctx);
      end;
      -- specs/coap_server.rflx:48:42
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      pragma Warnings (Off, "this statement is never reached");
      if not CoAP_Server.Definite_Message.Well_Formed (Ctx.P.Definite_Response_Ctx, CoAP_Server.Definite_Message.F_Message_Data) then
         Ctx.P.Next_State := S_Failure;
         pragma Assert (Treat_Request_Invariant);
         goto Finalize_Treat_Request;
      end if;
      ...
      pragma Warnings (On, "condition is always False");
      pragma Warnings (On, "condition can only be False if invalid values present");
      -- specs/coap_server.rflx:48:10
      if not CoAP_Server.Contains.CoAP_CoAP_Message_In_Definite_Message_Message_Data (Ctx.P.Definite_Response_Ctx) then
         Ctx.P.Next_State := S_Failure;
         pragma Assert (Treat_Request_Invariant);
         goto Finalize_Treat_Request;
      end if;
      if not CoAP_Server.Contains.Sufficient_Space_For_Message_Data (Ctx.P.Definite_Response_Ctx, Ctx.P.Response_Ctx) then
         Ctx.P.Next_State := S_Failure;
         pragma Assert (Treat_Request_Invariant);
         goto Finalize_Treat_Request;
      end if;
      CoAP_Server.Contains.Copy_Message_Data (Ctx.P.Definite_Response_Ctx, Ctx.P.Response_Ctx);
   ...
   begin
      ...
      pragma Warnings (Off, "statement has no effect");
      pragma Warnings (Off, "this statement is never reached");
      if not CoAP.CoAP_Message.Valid_Next (Ctx.P.Request_Ctx, CoAP.CoAP_Message.F_Token) then
         Ctx.P.Next_State := S_Receive_Request;
         pragma Assert (Failure_Invariant);
         goto Finalize_Failure;
      end if;
      ...
      pragma Warnings (Off, "statement has no effect");
      pragma Warnings (Off, "this statement is never reached");
      if not (RFLX.RFLX_Types.Base_Integer (RFLX.RFLX_Types.Base_Integer'First) <= RFLX.RFLX_Types.Base_Integer (CoAP.CoAP_Message.Field_Size (Ctx.P.Request_Ctx, CoAP.CoAP_Message.F_Token))) then
         Ctx.P.Next_State := S_Receive_Request;
         pragma Assert (Failure_Invariant);
         goto Finalize_Failure;
      end if;
      ...
      pragma Warnings (Off, "statement has no effect");
      pragma Warnings (Off, "this statement is never reached");
      if not (RFLX.RFLX_Types.Base_Integer (CoAP.CoAP_Message.Field_Size (Ctx.P.Request_Ctx, CoAP.CoAP_Message.F_Token)) <= RFLX.RFLX_Types.Base_Integer (RFLX.RFLX_Types.Base_Integer'Last)) then
         Ctx.P.Next_State := S_Receive_Request;
         pragma Assert (Failure_Invariant);
         goto Finalize_Failure;
      end if;
      ...
      pragma Warnings (On, "condition is always False");
      pragma Warnings (On, "condition can only be False if invalid values present");
      -- specs/coap_server.rflx:72:29
      T_1 := RFLX.RFLX_Types.Base_Integer (CoAP.CoAP_Message.Field_Size (Ctx.P.Request_Ctx, CoAP.CoAP_Message.F_Token));
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      pragma Warnings (Off, "this statement is never reached");
      if not (RFLX.RFLX_Types.Base_Integer (CoAP.Token_Length'First) <= RFLX.RFLX_Types.Base_Integer (T_1)) then
         Ctx.P.Next_State := S_Receive_Request;
         pragma Assert (Failure_Invariant);
         goto Finalize_Failure;
      end if;
      ...
      pragma Warnings (Off, "statement has no effect");
      pragma Warnings (Off, "this statement is never reached");
      if not (RFLX.RFLX_Types.Base_Integer (T_1) <= RFLX.RFLX_Types.Base_Integer (CoAP.Token_Length'Last)) then
         Ctx.P.Next_State := S_Receive_Request;
         pragma Assert (Failure_Invariant);
         goto Finalize_Failure;
      end if;
      ...
      if not RFLX.CoAP.CoAP_Message.Field_Condition (Ctx.P.Response_Ctx, RFLX.CoAP.CoAP_Message.F_TKL, CoAP.To_Base_Integer (CoAP.Token_Length'(CoAP.Token_Length (T_1) / 8))) then
         Ctx.P.Next_State := S_Receive_Request;
         pragma Assert (Failure_Invariant);
         goto Finalize_Failure;
      end if;
      CoAP.CoAP_Message.Set_TKL (Ctx.P.Response_Ctx, CoAP.Token_Length'(CoAP.Token_Length (T_1) / 8));
   ...
   begin
      CoAP_Server.Server_Loop.FSM_Allocator.Initialize (Ctx.P.Slots, Ctx.P.Memory);
      ...
      pragma Warnings (On, "unused assignment");
      CoAP_Server.Definite_Message.Initialize (Ctx.P.Definite_Response_Ctx, Definite_Response_Buffer);
      Ctx.P.Next_State := S_Receive_Request;
   end Initialize;
   ...
   begin
      ...
      CoAP_Server.Definite_Message.Take_Buffer (Ctx.P.Definite_Response_Ctx, Definite_Response_Buffer);
      ...
      pragma Assert (Ctx.P.Slots.Slot_Ptr_4 /= null);
      CoAP_Server.Server_Loop.FSM_Allocator.Finalize (Ctx.P.Slots);
   ...
   begin
      case Ctx.P.Next_State is
         ...
         when S_Treat_Request | S_Send_Response | S_Failure | S_Final =>
            null;
      end case;
