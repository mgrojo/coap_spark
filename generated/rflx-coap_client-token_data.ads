...
package RFLX.CoAP_Client.Token_Data with
  SPARK_Mode,
  Always_Terminates
is
   ...
   type Virtual_Field is (F_Initial, F_Length, F_Unused, F_Token, F_Final);

   subtype Field is Virtual_Field range F_Length .. F_Token;
   ...
   procedure Reset (Ctx : in out Context) with
     Pre =>
       not Ctx'Constrained
       and RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Take_Buffer (Ctx : in out Context; Buffer : out RFLX_Types.Bytes_Ptr) with
     Pre =>
       RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   procedure Copy (Ctx : Context; Buffer : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx)
       and then RFLX.CoAP_Client.Token_Data.Well_Formed_Message (Ctx)
       and then RFLX.CoAP_Client.Token_Data.Byte_Size (Ctx) = Buffer'Length;
   ...
   procedure Generic_Write (Ctx : in out Context; Offset : RFLX_Types.Length := 0) with
     Pre =>
       not Ctx'Constrained
       and then RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx)
       and then Offset < RFLX.CoAP_Client.Token_Data.Buffer_Length (Ctx)
       and then Pre (RFLX.CoAP_Client.Token_Data.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   procedure Data (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx)
       and then RFLX.CoAP_Client.Token_Data.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.CoAP_Client.Token_Data.Byte_Size (Ctx);
   ...
   function Field_Condition (Ctx : Context; Fld : Field) return Boolean with
     Pre =>
       RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx)
       and then RFLX.CoAP_Client.Token_Data.Valid_Next (Ctx, Fld)
       and then RFLX.CoAP_Client.Token_Data.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   function Field_Size (Ctx : Context; Fld : Field) return RFLX_Types.Bit_Length with
     Pre =>
       RFLX.CoAP_Client.Token_Data.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Token =>
   ...
   function Equal (Ctx : Context; Fld : Field; Data : RFLX_Types.Bytes) return Boolean with
     Pre =>
       RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx)
       and RFLX.CoAP_Client.Token_Data.Valid_Next (Ctx, Fld);
   ...
   function Get_Length (Ctx : Context) return RFLX.CoAP.Token_Length with
     Pre =>
       RFLX.CoAP_Client.Token_Data.Valid (Ctx, RFLX.CoAP_Client.Token_Data.F_Length);

   function Get_Unused (Ctx : Context) return RFLX.CoAP_Client.Unused_4 with
     Pre =>
       RFLX.CoAP_Client.Token_Data.Valid (Ctx, RFLX.CoAP_Client.Token_Data.F_Unused);
   ...
   function Get_Token (Ctx : Context) return RFLX_Types.Bytes with
     ...
     Pre =>
       RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx)
       and then RFLX.CoAP_Client.Token_Data.Well_Formed (Ctx, RFLX.CoAP_Client.Token_Data.F_Token)
       and then RFLX.CoAP_Client.Token_Data.Valid_Next (Ctx, RFLX.CoAP_Client.Token_Data.F_Token),
     Post =>
   ...
   procedure Get_Token (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.CoAP_Client.Token_Data.Well_Formed (Ctx, RFLX.CoAP_Client.Token_Data.F_Token)
       and then RFLX.CoAP_Client.Token_Data.Valid_Next (Ctx, RFLX.CoAP_Client.Token_Data.F_Token)
       and then Data'Length = RFLX_Types.To_Length (RFLX.CoAP_Client.Token_Data.Field_Size (Ctx, RFLX.CoAP_Client.Token_Data.F_Token)),
     Post =>
   ...
   procedure Generic_Get_Token (Ctx : Context) with
     Pre =>
       RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx)
       and RFLX.CoAP_Client.Token_Data.Present (Ctx, RFLX.CoAP_Client.Token_Data.F_Token);
   ...
   procedure Set_Length (Ctx : in out Context; Val : RFLX.CoAP.Token_Length) with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx)
       and then RFLX.CoAP_Client.Token_Data.Valid_Next (Ctx, RFLX.CoAP_Client.Token_Data.F_Length)
       and then RFLX.CoAP.Valid_Token_Length (RFLX.CoAP.To_Base_Integer (Val))
       and then RFLX.CoAP_Client.Token_Data.Available_Space (Ctx, RFLX.CoAP_Client.Token_Data.F_Length) >= RFLX.CoAP_Client.Token_Data.Field_Size (Ctx, RFLX.CoAP_Client.Token_Data.F_Length)
       and then RFLX.CoAP_Client.Token_Data.Field_Condition (Ctx, RFLX.CoAP_Client.Token_Data.F_Length),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_Length)
       and Get_Length (Ctx) = Val
       and Invalid (Ctx, F_Unused)
       and Invalid (Ctx, F_Token)
       and Valid_Next (Ctx, F_Unused)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
   ...
   procedure Set_Unused (Ctx : in out Context; Val : RFLX.CoAP_Client.Unused_4) with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx)
       and then RFLX.CoAP_Client.Token_Data.Valid_Next (Ctx, RFLX.CoAP_Client.Token_Data.F_Unused)
       and then RFLX.CoAP_Client.Valid_Unused_4 (RFLX.CoAP_Client.To_Base_Integer (Val))
       and then RFLX.CoAP_Client.Token_Data.Available_Space (Ctx, RFLX.CoAP_Client.Token_Data.F_Unused) >= RFLX.CoAP_Client.Token_Data.Field_Size (Ctx, RFLX.CoAP_Client.Token_Data.F_Unused)
       and then RFLX.CoAP_Client.Token_Data.Field_Condition (Ctx, RFLX.CoAP_Client.Token_Data.F_Unused),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_Unused)
       and Invalid (Ctx, F_Token)
       ...
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
       and Valid_Next (Ctx, F_Unused) = Valid_Next (Ctx, F_Unused)'Old
       and Get_Length (Ctx) = Get_Length (Ctx)'Old
       and Field_First (Ctx, F_Unused) = Field_First (Ctx, F_Unused)'Old
   ...
   procedure Set_Token_Empty (Ctx : in out Context) with
     Pre =>
       ...
       and then RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx)
       and then RFLX.CoAP_Client.Token_Data.Valid_Next (Ctx, RFLX.CoAP_Client.Token_Data.F_Token)
       and then RFLX.CoAP_Client.Token_Data.Available_Space (Ctx, RFLX.CoAP_Client.Token_Data.F_Token) >= RFLX.CoAP_Client.Token_Data.Field_Size (Ctx, RFLX.CoAP_Client.Token_Data.F_Token)
       and then RFLX.CoAP_Client.Token_Data.Field_Condition (Ctx, RFLX.CoAP_Client.Token_Data.F_Token)
       and then RFLX.CoAP_Client.Token_Data.Field_Size (Ctx, RFLX.CoAP_Client.Token_Data.F_Token) = 0,
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Token)
       and (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Token))
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
   ...
   procedure Initialize_Token (Ctx : in out Context) with
     ...
     Post =>
       ...
       and then (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Token))
       and then Ctx.Buffer_First = Ctx.Buffer_First'Old
       and then Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and then Ctx.First = Ctx.First'Old
       and then Ctx.Last = Ctx.Last'Old
   ...
   procedure Set_Token (Ctx : in out Context; Data : RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.CoAP_Client.Token_Data.Valid_Next (Ctx, RFLX.CoAP_Client.Token_Data.F_Token)
       and then RFLX.CoAP_Client.Token_Data.Available_Space (Ctx, RFLX.CoAP_Client.Token_Data.F_Token) >= RFLX.CoAP_Client.Token_Data.Field_Size (Ctx, RFLX.CoAP_Client.Token_Data.F_Token)
       and then RFLX.CoAP_Client.Token_Data.Valid_Length (Ctx, RFLX.CoAP_Client.Token_Data.F_Token, Data'Length)
       and then RFLX.CoAP_Client.Token_Data.Available_Space (Ctx, RFLX.CoAP_Client.Token_Data.F_Token) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.CoAP_Client.Token_Data.Field_Condition (Ctx, RFLX.CoAP_Client.Token_Data.F_Token),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Token)
   ...
   procedure Generic_Set_Token (Ctx : in out Context; Length : RFLX_Types.Length) with
     Pre =>
       ...
       and then RFLX.CoAP_Client.Token_Data.Valid_Next (Ctx, RFLX.CoAP_Client.Token_Data.F_Token)
       and then RFLX.CoAP_Client.Token_Data.Available_Space (Ctx, RFLX.CoAP_Client.Token_Data.F_Token) >= RFLX.CoAP_Client.Token_Data.Field_Size (Ctx, RFLX.CoAP_Client.Token_Data.F_Token)
       and then RFLX.CoAP_Client.Token_Data.Valid_Length (Ctx, RFLX.CoAP_Client.Token_Data.F_Token, Length)
       and then RFLX_Types.To_Length (RFLX.CoAP_Client.Token_Data.Available_Space (Ctx, RFLX.CoAP_Client.Token_Data.F_Token)) >= Length
   ...
   type Structure is
      record
         Length : RFLX.CoAP.Token_Length;
         Unused : RFLX.CoAP_Client.Unused_4;
         Token : RFLX_Types.Bytes (RFLX_Types.Index'First .. RFLX_Types.Index'First + 7);
      end record;
   ...
   procedure To_Context (Struct : Structure; Ctx : in out Context) with
     Pre =>
       not Ctx'Constrained
       and then RFLX.CoAP_Client.Token_Data.Has_Buffer (Ctx)
       and then RFLX.CoAP_Client.Token_Data.Valid_Structure (Struct)
       and then RFLX.CoAP_Client.Token_Data.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
   ...
   function Field_Size_Unused (Struct : Structure) return RFLX_Types.Bit_Length with
     Pre =>
       Valid_Structure (Struct);
...
private
   ...
   function Valid_Predecessors_Invariant (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return Boolean is
     ((if Well_Formed (Cursors (F_Length)) then True)
      and then (if Well_Formed (Cursors (F_Unused)) then Valid (Cursors (F_Length)))
      and then (if Well_Formed (Cursors (F_Token)) then Valid (Cursors (F_Unused))))
    with
     Pre =>
   ...
   function Field_First_Unused (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return RFLX_Types.Bit_Index'Base is
     (First + 4)
    with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, F_Unused);
   ...
   function Field_First_Internal (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Fld : Field) return RFLX_Types.Bit_Index'Base is
     ((case Fld is
          ...
          when F_Unused =>
             Field_First_Unused (Cursors, First, Verified_Last, Written_Last),
          when F_Token =>
   ...
   function Valid_Context (Buffer_First, Buffer_Last : RFLX_Types.Index; First : RFLX_Types.Bit_Index; Last : RFLX_Types.Bit_Length; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Buffer : RFLX_Types.Bytes_Ptr; Cursors : Field_Cursors) return Boolean is
     ((if
      ...
      and then ((if
                 ...
                 then
                    (Cursors (F_Length).Last - Cursors (F_Length).First + 1 = 4
                     and then Cursors (F_Length).First = First))
                and then (if
                             Well_Formed (Cursors (F_Unused))
                          then
                             (Cursors (F_Unused).Last - Cursors (F_Unused).First + 1 = 4
                              and then Cursors (F_Unused).First = Cursors (F_Length).Last + 1))
                and then (if
                             Well_Formed (Cursors (F_Token))
                          then
                             (Cursors (F_Token).Last - Cursors (F_Token).First + 1 = RFLX_Types.Bit_Length (Cursors (F_Length).Value) * 8
                              and then Cursors (F_Token).First = Cursors (F_Unused).Last + 1))))
    with
     Post =>
       True;
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.CoAP_Client.Token_Data.Field_First (Ctx, RFLX.CoAP_Client.Token_Data.F_Length) rem RFLX_Types.Byte'Size = 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     ((case Fld is
          ...
          when F_Unused =>
             RFLX.CoAP_Client.Valid_Unused_4 (Val),
          when F_Token =>
             True));

   function Field_Condition (Ctx : Context; Fld : Field) return Boolean is
     ((case Fld is
          when F_Length | F_Unused | F_Token =>
             True));
   ...
   function Get_Length (Ctx : Context) return RFLX.CoAP.Token_Length is
     (To_Actual (Ctx.Cursors (F_Length).Value));

   function Get_Unused (Ctx : Context) return RFLX.CoAP_Client.Unused_4 is
     (To_Actual (Ctx.Cursors (F_Unused).Value));
