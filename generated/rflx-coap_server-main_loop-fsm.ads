...
with RFLX.CoAP_Server.Main_Loop.FSM_Allocator;
...
package RFLX.CoAP_Server.Main_Loop.FSM with
  SPARK_Mode
is
   ...
   type State is (S_Receive_Request, S_Treat_Request, S_Success_Response, S_Client_Error_Response, S_Server_Error_Response, S_Send_Response, S_Failure, S_Final);
   ...
   type Context is limited
      record
         P : Private_Context;
         E : RFLX.CoAP_Server.Main_Loop_Environment.State;
      end record;
...
private
   ...
   type Private_Context is
      record
         ...
         Definite_Response_Ctx : CoAP_Server.Application_Response.Context;
         Slots : CoAP_Server.Main_Loop.FSM_Allocator.Slots;
         Memory : CoAP_Server.Main_Loop.FSM_Allocator.Memory;
      end record;
   ...
   function Uninitialized (Ctx : Context) return Boolean is
     (not CoAP.CoAP_Message.Has_Buffer (Ctx.P.Request_Ctx)
      ...
      and not CoAP_Server.Application_Response.Has_Buffer (Ctx.P.Definite_Response_Ctx)
      and CoAP_Server.Main_Loop.FSM_Allocator.Uninitialized (Ctx.P.Slots));
   ...
   function Global_Initialized (Ctx : Context) return Boolean is
     (CoAP.CoAP_Message.Has_Buffer (Ctx.P.Request_Ctx)
      ...
      and then CoAP_Server.Application_Response.Has_Buffer (Ctx.P.Definite_Response_Ctx)
   ...
   function Global_Allocated (Ctx : Context) return Boolean is
     (CoAP_Server.Main_Loop.FSM_Allocator.Global_Allocated (Ctx.P.Slots));
