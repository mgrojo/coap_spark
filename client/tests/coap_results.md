...
# Document: [coap_client_tests.md](coap_client_tests.md)  
  ## Feature: CoAP Client command line  
   ### Scenario: [version message](coap_client_tests.md): 
   ...
   ### Scenario: [help message](coap_client_tests.md): 
   ...
   ### Scenario: [usage message on unrecognized option](coap_client_tests.md): 
   ...
   ### Scenario: [no URI](coap_client_tests.md): 
   ...
   ### Scenario: [no value for -k](coap_client_tests.md): 
   ...
   ### Scenario: [Payload already provided](coap_client_tests.md): 
   ...
   ### Scenario: [Payload too long](coap_client_tests.md): 
   - OK : When I run `../bin/coap_client -e "" coap://coap.me/`  
   - OK : Then I get an error  
   - OK : And output contains `Payload too long`  
   - [X] scenario   [Payload too long](coap_client_tests.md) pass  

   ### Scenario: [invalid verbosity level](coap_client_tests.md): 
   ...
   ### Scenario: [Verbosity level too high](coap_client_tests.md): 
   ...
   ### Scenario: [invalid argument](coap_client_tests.md): 
   ...
   ### Scenario: [communication problems](coap_client_tests.md): 
  ...
  ## Feature: ETSI CoAP plugtest  
   ...
   ### Scenario: [get method with test path and high verbosity II](coap_client_tests.md): 
   - OK : When I run `../bin/coap_client -v 4 coap://coap.me/test`  
   - OK : Then I get no error  
   - OK : And the output contains   
   - [X] scenario   [get method with test path and high verbosity II](coap_client_tests.md) pass  

   ### Scenario: [get method without path](coap_client_tests.md): 
   ...
   ### Scenario: [explicit get method with IP and path](coap_client_tests.md): 
   ...
   ### Scenario: [get "weird33" path](coap_client_tests.md): 
   ...
   ### Scenario: [get "weird44" (unknown elective option I)](coap_client_tests.md): 
   ...
   ### Scenario: [get "weird44" (unknown elective option II)](coap_client_tests.md): 
   ...
   ### Scenario: [get "weird55" path](coap_client_tests.md): 
   ...
   ### Scenario: [get "weird333" path](coap_client_tests.md): 
   ...
   ### Scenario: [get "weird3333" path](coap_client_tests.md): 
   ...
   ### Scenario: [get "weird33333" path](coap_client_tests.md): 
   ...
   ### Scenario: [get "123412341234123412341234" path](coap_client_tests.md): 
  ...
  ## Feature: some miscelaneous error conditions  
   ### Scenario: [invalid CoAP URI (invalid scheme and path)](coap_client_tests.md): 
   ...
   ### Scenario: [invalid CoAP URI (invalid scheme and no path)](coap_client_tests.md): 
   - OK : When I run `../bin/coap_client http://coap.me`  
   - OK : Then I get an error  
   - OK : And output contains `invalid URI`  
   - [X] scenario   [invalid CoAP URI (invalid scheme and no path)](coap_client_tests.md) pass  

   ### Scenario: [invalid CoAP URI (no scheme)](coap_client_tests.md): 
   - OK : When I run `../bin/coap_client coap.me`  
   - OK : Then I get an error  
   - OK : And output contains `invalid URI`  
   - [X] scenario   [invalid CoAP URI (no scheme)](coap_client_tests.md) pass  

   ### Scenario: [URI too long](coap_client_tests.md): 
   - OK : When I run `../bin/coap_client coap:.org/`  
   - OK : Then I get an error  
   - OK : And output contains `URI too long`  
   - [X] scenario   [URI too long](coap_client_tests.md) pass  

   ### Scenario: [invalid CoAP method](coap_client_tests.md): 
