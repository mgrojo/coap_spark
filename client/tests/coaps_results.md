...
# Document: [coaps_client_tests.md](coaps_client_tests.md)  
  ## Feature: CoAP secure communication with server  
   ### Scenario: [get method with test path and high verbosity I](coaps_client_tests.md): 
   ...
   ### Scenario: [get method without path](coaps_client_tests.md): 
   ...
   ### Scenario: [get method with empty path](coaps_client_tests.md): 
   - OK : When I run `../bin/coap_client -k COAP_SPARK_KEY_5684 -u coap_spark coaps://localhost/`  
   - OK : Then I get no error  
   - OK : And output contains `This is a test server made with libcoap`  
   - [X] scenario   [get method with empty path](coaps_client_tests.md) pass  

   ### Scenario: [get method with port and no path](coaps_client_tests.md): 
   ...
   ### Scenario: [put method with path](coaps_client_tests.md): 
   ...
   ### Scenario: [explicit get method with path](coaps_client_tests.md): 
   ...
   ### Scenario: [explicit get method with IP and path](coaps_client_tests.md): 
   ...
   ### Scenario: [get method with port and path](coaps_client_tests.md): 
   ...
   ### Scenario: [put method within previous resource](coaps_client_tests.md): 
   ...
   ### Scenario: [get method with nested resource](coaps_client_tests.md): 
   ...
   ### Scenario: [get non-existent resource with path](coaps_client_tests.md): 
   ...
   ### Scenario: [put on long path](coaps_client_tests.md): 
   ...
   ### Scenario: [get "123412341234123412341234" path](coaps_client_tests.md): 
   ...
   ### Scenario: [explicit get with error 4.04](coaps_client_tests.md): 
   ...
   ### Scenario: [delete method with path](coaps_client_tests.md): 
   ...
   ### Scenario: [explicit get method with path of just deleted resource](coaps_client_tests.md): 
   - OK : When I run `../bin/coap_client -m get -k COAP_SPARK_KEY_5684 -u coap_spark coaps://localhost/test`  
   - OK : Then I get no error  
   - OK : And the output is  
  ...
  ## Feature: some miscelaneous error conditions  
   ### Scenario: [coaps not supported by server](coaps_client_tests.md): 
   ...
   ### Scenario: [Key too long](coaps_client_tests.md): 
...
## Summary : **Success**, 19 scenarios OK
